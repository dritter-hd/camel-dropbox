...
public class DropboxCopyFolderComponentTest extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        ...
        return new RouteBuilder() {
            public void configure() {
                from(
                        "dropbox://get_folder?path=" + "/Public/Inbox" + "&appKey=" + appKey + "&appSecret=" + appSecret + "&accessToken="
                                + accessToken).to(
                        "dropbox://add?path=" + "/Public/SubPublicFromInbox" + "&appKey=" + appKey + "&appSecret=" + appSecret + "&accessToken="
